...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'available_locales' } = {
        summary => '',
        params => $params,
...
sub available_locales {
    ...
    # parse inputs
    my $_resource_path = '/available_locales';
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'healthcheck' } = {
        summary => '',
        params => $params,
        returns => 'string',
        };
