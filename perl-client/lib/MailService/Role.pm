...
has _cfg => ( is => 'ro',
              isa => 'MailService::Configuration',
              default => sub { MailService::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'mb-mail-service',
                          app_version => '0.1.0',
                          generator_version => '7.8.0-SNAPSHOT',
...
sub _build_af {
    ...
    return MailService::ApiFactory->new(%args);
}
...
=head2 mb-mail-service version: 0.1.0
...
=item Generator version: 7.8.0-SNAPSHOT
