...
use MailService::Configuration;

sub new {
    my $class = shift;

    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'MailService::Configuration' ) {
        $config = $_[0];
    } else {
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("MailService::Object::$class")->new;
        if (ref $data eq "HASH") {
